...
@Component({
    selector: 'jhi-province-mojobs',
    templateUrl: './province-mojobs.component.html'
})
export class ProvinceMojobsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: ProvinceMojobs) {
        return item.id;
    }
