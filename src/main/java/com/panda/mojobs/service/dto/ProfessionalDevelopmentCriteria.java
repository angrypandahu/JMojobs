...
/**
 * Criteria class for the ProfessionalDevelopment entity. This class is used in ProfessionalDevelopmentResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /professional-developments?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class ProfessionalDevelopmentCriteria implements Serializable {
    ...
    public ProfessionalDevelopmentCriteria() {
    }
    ...
    public String toString() {
        return "ProfessionalDevelopmentCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (name != null ? "name=" + name + ", " : "") +
