...
@Component({
    selector: 'jhi-city-mojobs',
    templateUrl: './city-mojobs.component.html'
})
export class CityMojobsComponent implements OnInit, OnDestroy {
    ...
    trackId(index: number, item: CityMojobs) {
        return item.id;
    }
