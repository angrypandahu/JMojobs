...
@Injectable()
export class MLanguageMojobsPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.mLanguageModalRef(component, new MLanguageMojobs());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    mLanguageModalRef(component: Component, mLanguage: MLanguageMojobs): NgbModalRef {
