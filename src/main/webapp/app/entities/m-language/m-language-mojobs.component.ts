...
@Component({
    selector: 'jhi-m-language-mojobs',
    templateUrl: './m-language-mojobs.component.html'
})
export class MLanguageMojobsComponent implements OnInit, OnDestroy {
mLanguages: MLanguageMojobs[];
    currentAccount: any;
    ...
    trackId(index: number, item: MLanguageMojobs) {
        return item.id;
    }
