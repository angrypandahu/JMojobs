...
@Component({
    selector: 'jhi-chat-message-mojobs',
    templateUrl: './chat-message-mojobs.component.html'
})
export class ChatMessageMojobsComponent implements OnInit, OnDestroy {

    chatMessages: ChatMessageMojobs[];
    currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.chatMessageService.search({
    ...
    trackId(index: number, item: ChatMessageMojobs) {
        return item.id;
    }
