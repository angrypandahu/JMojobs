...
@Injectable()
export class AddressMojobsPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.addressModalRef(component, new AddressMojobs());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    addressModalRef(component: Component, address: AddressMojobs): NgbModalRef {
